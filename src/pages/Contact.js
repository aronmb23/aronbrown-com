...
export function Contact() {
    ...
    <section class="page max-w-4xl mx-auto px-6 py-20 md:py-32 animate-fade-in-up">
      <div class="text-center">
        ...
        <p class="text-lg text-slate-300 leading-relaxed max-w-2xl mx-auto mb-12">
        ...
        <a href="mailto:hello@aronbrown.com" class="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-sky-500 text-white font-bold text-lg hover:bg-sky-400 transition-all hover:scale-105 shadow-lg shadow-sky-500/25">
